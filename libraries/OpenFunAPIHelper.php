 ...
 *   2. 每支 API action 最開頭呼叫 OpenFunAPIHelper::checkUsage(['service' => 'ccapi', ...]);
 ...
 *
 * 與 ly.govapi.tw-v2 的 libraries/OpenFunAPIHelper.php 是同一份共用類別（逐字複製），
 * 這裡不要各自演化出不同版本——之後若要調整驗證/記錄邏輯，兩邊要一起同步。
 */
class OpenFunAPIHelper
{
     ...
     *
     * $options:
     *   'service' => string  本服務識別符，用於 scope 比對（如 'ccapi'）
