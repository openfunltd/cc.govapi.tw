 ...
 * 連署人/案由/說明/辦法/審查意見/議決/來源檔案/來源頁碼/來源網址/備註/會議代碼/
 * 提案人結構/連署人結構）
 * 所有來源欄位直接沿用原始名稱匯入 ES
 * 「來源網址」是議事錄原始 PDF/Word 在該議會官網的直連下載網址（「官方來源」），
 * 跟「來源檔案」「來源頁碼」（檔案內來源）合起來才是完整的溯源資訊；實測部分議會
 * 網站有 Cloudflare 擋自動化請求（curl 回 403），網址本身格式正常，用瀏覽器應該
 * 沒問題，只是沒辦法用程式自動驗證每一筆都能下載
